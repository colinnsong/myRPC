...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::RpcHeader* Arena::CreateMaybeMessage<::fixbug::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace fixbug {
...
class RpcHeader :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.RpcHeader) */ {
 public:
  RpcHeader();
  virtual ~RpcHeader();
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 args_size() const;
  void set_args_size(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_args_size() const;
  void _internal_set_args_size(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // @@protoc_insertion_point(class_scope:fixbug.RpcHeader)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 args_size_;
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:fixbug.RpcHeader.service_name)
  return _internal_service_name();
}
inline void RpcHeader::set_service_name(const std::string& value) {
  _internal_set_service_name(value);
  // @@protoc_insertion_point(field_set:fixbug.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  // @@protoc_insertion_point(field_mutable:fixbug.RpcHeader.service_name)
...
inline void RpcHeader::set_service_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:fixbug.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:fixbug.RpcHeader.service_name)
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:fixbug.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:fixbug.RpcHeader.method_name)
  return _internal_method_name();
}
inline void RpcHeader::set_method_name(const std::string& value) {
  _internal_set_method_name(value);
  // @@protoc_insertion_point(field_set:fixbug.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  // @@protoc_insertion_point(field_mutable:fixbug.RpcHeader.method_name)
...
inline void RpcHeader::set_method_name(std::string&& value) {
  ...
  method_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:fixbug.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const void* value, size_t size) {
  ...
  method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.RpcHeader.method_name)
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:fixbug.RpcHeader.method_name)
...
inline void RpcHeader::set_allocated_method_name(std::string* method_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.RpcHeader.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RpcHeader::_internal_args_size() const {
  return args_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:fixbug.RpcHeader.args_size)
  return _internal_args_size();
}
inline void RpcHeader::_internal_set_args_size(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  args_size_ = value;
}
inline void RpcHeader::set_args_size(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_args_size(value);
  // @@protoc_insertion_point(field_set:fixbug.RpcHeader.args_size)
}
